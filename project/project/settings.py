...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'wailtareq.m@gmail.com'
EMAIL_HOST_PASSWORD = 'ogonggyksfldngft'
EMAIL_USE_TLS = True
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user-create': 'appexample.serializers.UserCreateSerializer',
        'user': 'appexample.serializers.UserCreateSerializer',
