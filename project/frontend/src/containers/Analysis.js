                ...
                <Flex direction='column' background='#EDF2F7' p={10} rounded={6}>
                    ...
                    >
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>Oxygen Generated</StatLabel>
                        ...
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>Carbon Absorbed</StatLabel>
                        ...
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>CO2 Absorbed in Equivelance to Miles Driven</StatLabel>
                        ...
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>Water Needed</StatLabel>
                        ...
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>Water Saved and Generated Daily</StatLabel>
                        ...
                        <Popover>
                            <PopoverTrigger>
                                    <HStack cursor='pointer'>
                                        <StatLabel fontSize='2xl'>Pollutants Absorbed</StatLabel>
